# Let us try to find all dominant strategies in a strategic form game.
...
for player in range(n_players):
    ...
    print(f"Strongly Dominant strategies for player-{player_}: {Strategy_equilibria[player]}")

if "Does not exist" not in Strategy_equilibria:
    print("Strongly Dominant Strategy Equilibrium: ", Strategy_equilibria)
